        ...
        foreach ($taxonomies as $taxonomy) :
            ...
            <div class="wizhi-select">
                ...
                if ($count > 0) :
                    ...
                    echo '<li><a class="'.$is_all.'" href="'.remove_query_arg($exclude_all_var).'">所有</a><li>';
                    foreach ($terms as $term) :
                        ...
                        if (get_query_var($query_var) == $term->slug) {
                            echo '<a href="'.remove_query_arg($exclude_current_var).'" class="selected">'.$term->name."</a>";
                        } else {
                            echo '<a href="'.remove_query_arg($exclude_term_var, add_query_arg($include_term_var)).'">'.$term->name."</a>";
                        }
